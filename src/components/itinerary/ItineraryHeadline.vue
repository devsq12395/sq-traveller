<template>
  <div class="itinerary-headline flex flex-col justify-end items-center border mx-auto sticky top-0 z-10" :style="{ width: '30%', height: '50vh', backgroundImage: `url(${itineraryImgUrl})`, backgroundSize: 'cover', backgroundPosition: 'center' }">
